...
const Products = memo(() => {
    ...
    return(
        <section className="px-10 mt-[30px] flex flex-col gap-6 max-[992px]:px-4 max-[992px]:mt-3">
            <h2  className="text-[24px] font-semibold font-mont max-[400px]:text-[24px] capitalize">All products</h2>
            ...
            </div>
            {
                 getProductMutation.isFetchingNextPage && (
                    <div className="flex justify-center items-center">
                        <span className="text-[16px] font-mont font-medium mr-2">Loading...</span>
                        <Oval
                            visible={true}
                            height="20"
                            width="20"
