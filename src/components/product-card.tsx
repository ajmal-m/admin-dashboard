...
const ProductCard = memo(({ product }:{ product: ProductType}) => {
    ...
    return(
        ...
        >
            ...
            <p className="font-mont text-[#000000] text-[16px] min-[600px]:text-[20px] items-left">{product.quantityType}</p>
            <div className="w-full flex items-center justify-between">
                <p className="font-mont text-[#000000] text-[20px] min-[600px]:text-[24px]">₹ {product.price}</p>
                {
                    selectedQuantity > 0 ? (
                        <button
                            className="min-w-22 px-4 py-2 bg-[#0B6434] text-white rounded-[5px] font-mont text-[16px] font-semibold"
                            type="button"
                        >
                        ...
                        <button
                            className="min-w-22 px-4 py-2 bg-[white] text-[#0B6434] border border-[#0B6434] rounded-[5px] cursor-pointer font-mont text-[16px] font-semibold"
                            type="button"
